<cfoutput>
	...
	<div class="row">
		<div class="col-md-8 offset-md-2 col-lg-6 offset-lg-3">
			<form name="resetFrm" method="post" action="#buildURL('auth:main.resetPasswordAct')#">
				<input type="hidden" name="token_txt" value="#rc.token_txt#"/>
				<div class="card login mt-5">
					<p class="h3 card-header">Create a new Password</p>
					<div class="card-block">
						<p>Passwords must be at least:</p>
						<ul><li>Eight (8) characters in length</li></ul>
